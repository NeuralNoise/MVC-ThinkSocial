...
INSERT INTO `users` (id, first_name, middle_name, last_name, email, birthday, sex, status) VALUES
(1,'Вадим','Александрович','Малец','abc@bb.bb','1996-04-27','male','active'),
(2,'Илья','Юрьевич','Морква','test@bb.eu','1996-04-28','female','active'),
(3,'Александр','Анатольевич','Бричак','brichak@bb.ua','2009-04-27','male','active'),
(4,'Вася','Васильевич','Васильев','vasya@bb.ru','1997-01-01','male','active'),
(5,'Ирина','Александровна','Прекрасная','ira@bb.ru','1981-01-14','female','active'),
(6,'Даша','Фёдоровна','Федорова','dasha@bb.ru','1989-09-09','female','active');
...
insert into albums_photos (album_id, file_name, description) values
	(6, 'Leo.jpg', 'А это мечта :)'), (6, 'Scarlett.jpg', 'Познакомились в ночном клубе');
